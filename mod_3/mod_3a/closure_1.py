...
print(mul3.__code__.co_freevars)  # ('n',) свободная
print(mul3.__code__.co_varnames)  # ('k',) локальная
print(mul3.__closure__)  # (<cell at 0x01C99190: int object at 0x526F6480>,)
print(mul3.__closure__[0].cell_contents)  # 3
...
# присвоения значений параметру по умолчанию не приведут к изменению ранее определённой функции:
n = 7
print(mult(3))  # 9
n = 13
print(mult(5))  # 15
